    ...
    <div v-if="trendingShortPost" class="trending-news-post-items">
      <div class="gallery_item">
        ...
        <div class="gallery_item_content">
          ...
          <h4 class="title">
            <a href="#">San Valentín: los mejores cócteles para brindar por el amor</a>
          </h4>
        </div>
      </div>
      <div class="gallery_item">
        ...
        <div class="gallery_item_content">
          ...
          <h4 class="title">
            <a href="#">Platos con moho: provocación y belleza en la alta cocina</a>
          </h4>
        </div>
      </div>
      <div class="gallery_item">
        ...
        <div class="gallery_item_content">
          ...
          <h4 class="title">
            <a href="#">Los mejores anillos de plata para mujer</a>
          </h4>
        </div>
      </div>
    </div>
