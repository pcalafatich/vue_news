    ...
    <section class="feature-area">
        <div class="container">
            ...
            <div class="feature-post-slider position-relative">
                <span @click="featureSliderPrev" class="prev slick-arrow" style="display: block"><i class="fal fa-angle-left"></i></span>
                ...
                <span @click="featureSliderNext" class="next slick-arrow" style="display: block"><i class="fal fa-angle-right"></i></span>
            </div>
        </div>
    </section>
</template>
