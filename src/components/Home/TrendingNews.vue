            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="trending-news-slider position-relative">
                        <span @click="trandingPrev" class="prev slick-arrow" style="display: block"><i class="fal fa-angle-left"></i></span>
                        ...
                        <span @click="trandingNext" class="next slick-arrow" style="display: block"><i class="fal fa-angle-right"></i></span>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div :class="['trending-news-post-items', darkClass && 'news_section' in darkClass ? darkClass.news_section : '',]">
                                <template v-for="(small, index) in smallPostGallery.slice(0, 3)">
                                    <row-card :class="[darkClass && 'news_item' in darkClass ? darkClass.news_item : '',]" :key="index" :trending="true" :datas="small" />
                                </template>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-4">
                    <div class="trending-right-sidebar">
                        ...
                        <div class="trending-sidebar-slider position-relative">
                            <span @click="tssPrev" class="prev slick-arrow" style="display: block"><i class="fal fa-angle-left"></i></span>
                            <slider :settings="trendingSidebarSlide" ref="trendingSidebarSlide">
                                <div class="post_gallery_items">
                                    <template v-for="(small, index) in smallPostGallery.slice(0, 6)">
                                        <row-card :class="[darkClass && 'news_item' in darkClass ? darkClass.news_item : '',]" :key="index" :counting="true" :count="index + 1" :datas="small" />
                                    </template>
                                </div>
                                <div class="post_gallery_items">
                                    <template v-for="(small, index) in smallPostGallery.slice(0, 6)">
                            ...
                            <span @click="tssNext" class="next slick-arrow" style="display: block"><i class="fal fa-angle-right"></i></span>
                        </div>
                    </div>
                </div>
            </div>
