                        ...
                        <div class="col-lg-8">
                            <div class="about-tab-btn mt-40">
                                <div class="archive-btn">
                                    <ul>
                                        <li>
                                            <span>Categoría: <span>Negocios</span></span>
                                        </li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="trending-news-item">
                                                            <div class="trending-news-content">
                                                                ...
                                                                <h3 class="title">
                                                                    <router-link to="/posts/postOne">There may be no consoles in the future ea exec says</router-link>
                                                                </h3>
                                                                <p class="text">
                                                                    Suspendisse potenti. Aenean finibus vitae velit nec dapibus. Donec eu aliquam urna, vitae tincidunt tellus. Vivamus egestas massa vitae porttitor ullamcorper.
                                                                </p>
                                                                <a href="#">Leer más</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="trending-news-item">
                                                            <div class="trending-news-content">
                                                                ...
                                                                <h3 class="title">
                                                                    <router-link to="/posts/postOne">Cómo se vive hoy en Milán el camino hacia la post-pandemia</router-link>
                                                                </h3>
                                                                <p class="text">
                                                                    La ciudad italiana avanza lentamente hacia el fin de la pandemia entre restricciones cambiantes e instantes de libertad.
                                                                </p>
                                                                <a href="#">Leer más</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="trending-news-item">
                                                            <div class="trending-news-content">
                                                                ...
                                                                <h3 class="title">
                                                                    <router-link to="/posts/postOne">There may be no consoles in the future ea
